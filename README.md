...
- HECHO Buscar y listar películas.
- HECHO Ver los detalles de una película o programa de televisión.
- HECHO Crear usuarios.
- HECHO _Loguear_ y _desloguear_ usuarios.

📘 **Prioridad Media** (_Should Have_)

- HECHO Agregar una película o programa a una lista de favoritos.
- HECHO Ver una lista de favoritos.
- HECHO Remover una película o programa de una lista de favoritos.
- HECHO Diferenciar las rutas de _front-end_ para películas y programas de televisión.

📗 **Prioridad Normal** (_Could Have_)

- Buscar usuarios.
- Ver el perfil de un usuario específico (con sus películas o programas favoritos).
- HECHO Mantener sesión abierta ante un cierre del _browser_ o `refresh`.
